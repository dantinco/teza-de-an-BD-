...
if(isset($_POST['submit'])){
  ...
  $volum = $_POST['volum'];
    ...
    $sql="UPDATE `catalog` SET id_catalog='$id_catalog', denumire_vin='$denumire_vin', id_culoare='$id_culoare', id_clasificare='$id_clasificare', pret='$pret', id_producator='$id_producator', an='$an', volum='$volum'
